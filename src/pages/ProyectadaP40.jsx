...
const ProyectadaP40 = () => {
  ...
  const handleAdd = () => {
    ...
    const calculated = calcular(anchoDec, altoDec)
    ...
    const newResult = {
      ...
      alto: formData.alto,
      hojas: '1 Hoja',
      cabVen: FractionUtils.toSixteenths(calculated.cabVen),
      latVen: FractionUtils.toSixteenths(calculated.latVen),
  ...
  const handlePrint = () => {
    ...
    const title = 'VENTANA PROYECTADA P-40'
    ...
    let tableHtml = `
      <table style="width:100%; border-collapse:collapse; margin:10px 0; border:1px solid #1e2b3c;">
        <thead>
          ...
          <tr>
            <th style="background:#2c3e50; color:white; padding:4px 6px; border:1px solid #2c3e50; font-size:10px;">Cab-ven</th>
            <th style="background:#2c3e50; color:white; padding:4px 6px; border:1px solid #2c3e50; font-size:10px;">Lat-ven</th>
    ...
    results.forEach(row => {
      tableHtml += `
        <tr>
          ...
          <td style="border:1px solid #adb5bd; padding:4px 6px; text-align:center; font-size:10px;">${row.cabVen}</td>
          <td style="border:1px solid #adb5bd; padding:4px 6px; text-align:center; font-size:10px;">${row.latVen}</td>
  ...
  const handleExportPDF = () => {
    ...
    const options = {
      ...
      filename: 'proyectada-p40-desglose.pdf',
          ...
          <div className="card-modern mb-4" style={{ padding: '1rem' }}>
            <div className="row g-3">
              ...
              <div className="col-md-3">
                ...
                <input type="text" name="ancho" value={formData.ancho} onChange={handleFormChange} placeholder="ej: 38 10/16" className="form-control" />
              </div>
              <div className="col-md-3">
                <label className="form-label small fw-bold">ALTO</label>
                <input type="text" name="alto" value={formData.alto} onChange={handleFormChange} placeholder="ej: 27 15/16" className="form-control" />
              </div>
              <div className="col-md-3 d-flex align-items-end">
                <Button variant="primary" onClick={handleAdd} className="w-100">➕ AGREGAR</Button>
              </div>
            </div>
                    ...
                    <tbody>
                      {results.map((row, idx) => (
                        <tr key={idx}>
                          ...
                          <td style={{ padding: '0.25rem' }}>{row.cabVen}</td>
                          <td style={{ padding: '0.25rem' }}>{row.latVen}</td>
