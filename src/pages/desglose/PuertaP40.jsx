...
<h1>NUEVO PUERTA P40</h1>
<h2>SISTEMA PROFESIONAL DE CÁLCULO</h2>

<div class="info">
  <span>
    <strong>CUENTA:</strong> ${projectInfo.cuenta || '—'}
  </span>

  <span>
    <strong>OBRA:</strong> ${projectInfo.obra || '—'}
  </span>

  <span>
    <strong>COLOR:</strong> ${projectInfo.color || '—'}
  </span>
</div>
...
export default function NuevoPuertaP40() {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      alert(
        '✅ Desglose de Puerta P40 guardado correctamente en el historial.'
      )
    } catch (err) {
      console.error(
        'Error guardando desglose Puerta P40:',
        err
      )

      alert('❌ No se pudo guardar el desglose.')
    }
  }
