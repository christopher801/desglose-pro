...
export default function E70() {
  ...
  const handleAdd = () => {
    ...
    setResults([...results, {
      ...
      vidrioMedio: calc.vidrioMedio !== null ? FractionUtils.toSixteenths(calc.vidrioMedio) : null
    }])
  ...
  const handleReset = () => {
    setResults([])
    setForm({ hueco: '', ancho: '', alto: '', hojas: 2 })
  ...
  const handlePrint = () => {
    ...
    const html = `<!DOCTYPE html><html><head><title>VENTANA E-70</title>
    ...
    <body><h1>VENTANA E-70</h1><h2>SISTEMA PROFESIONAL DE CÁLCULO</h2>
    <div class="info">
    ...
    <Layout>
      <div className="page-content">
        ...
        <div className="desglose-header">
          ...
          <h1 className="page-title">Ventana E-70</h1>
        ...
        {results.length > 0 && (
          <div className="table-container">
            <div className="table-title">VENTANA E-70</div>
