...
export default function E70() {
  ...
  const handleAdd = () => {
    ...
    const newResult = {
      hueco: form.hueco || `H-${results.length + 1}`,
      ancho: form.ancho,
      alto: form.alto,
      hojas: `${hojas} hojas`,
  ...
  const handleSave = () => {
    ...
    try {
      ...
      alert('✅ Desglose E-70 guardado correctamente en el historial.')
    } catch (err) {
      console.error('Error guardando desglose:', err)
