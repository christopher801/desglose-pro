// src/pages/desglose/components/MaterialPuertaP40.jsx
...
export default function MaterialPuertaP40({ medidas = [] }) {
  const materiales = useMemo(() => {
    return calcularResumenMaterialesPuertaP40(medidas);
  }, [medidas]);

  const totales = useMemo(() => {
    return calcularTotalesMaterialesPuertaP40(materiales);
  }, [materiales]);
    ...
    >
      ...
      >
        ...
        >
          ...
          <span>MATERIALES PUERTA P-40</span>
        </div>
      ...
      >
        ...
        Los materiales de todas las puertas fueron agrupados
