...
import {
  ...
  calcularTotalesMaterialesE70,
  BARRA_PIES,
} from "../../../utils/e70Materials";

export default function MaterialE70({
  medidas = [],
}) {
  const materiales = useMemo(() => {
    return calcularResumenMaterialesE70(medidas);
  }, [medidas]);

  const totales = useMemo(() => {
    return calcularTotalesMaterialesE70(materiales);
  }, [materiales]);
