...
import {
  ...
  calcularTotalesMaterialesM100,
  BARRA_PIES,
} from "../../../utils/m100Materials";

export default function MaterialM100({
  medidas = [],
}) {
  const materiales = useMemo(() => {
    return calcularResumenMaterialesM100(medidas);
  }, [medidas]);

  const totales = useMemo(() => {
    return calcularTotalesMaterialesM100(materiales);
  }, [materiales]);
