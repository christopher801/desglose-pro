// src/pages/desglose/components/MaterialP92.jsx

import React, { useMemo } from "react";
import FractionUtils from "../../../utils/fraction";

import {
  calcularResumenMaterialesP92,
  calcularTotalesMaterialesP92,
  BARRA_PIES,
} from "../../../utils/p92Materials";

export default function MaterialP92({ medidas = [] }) {
  const materiales = useMemo(() => {
    return calcularResumenMaterialesP92(medidas);
  }, [medidas]);

  const totales = useMemo(() => {
    return calcularTotalesMaterialesP92(materiales);
  }, [materiales]);
