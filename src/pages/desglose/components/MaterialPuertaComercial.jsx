// src/pages/desglose/components/MaterialPuertaComercial.jsx
...
export default function MaterialPuertaComercial({
  medidas = [],
}) {
  const materiales = useMemo(() => {
    return calcularResumenMaterialesPuertaComercial(
      medidas
    );
  }, [medidas]);

  const totales = useMemo(() => {
    return calcularTotalesMaterialesPuertaComercial(
      materiales
    );
  }, [materiales]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        Los materiales de todas las puertas
