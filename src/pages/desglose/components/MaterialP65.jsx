...
import {
  ...
  calcularTotalesMaterialesP65,
  BARRA_PIES,
} from "../../../utils/p65Materials";

export default function MaterialP65({ medidas = [] }) {
  const materiales = useMemo(() => {
    return calcularResumenMaterialesP65(medidas);
  }, [medidas]);

  const totales = useMemo(() => {
    return calcularTotalesMaterialesP65(materiales);
  }, [materiales]);
