...
import MaterialM100 from "./components/MaterialM100";

import { saveDesglose } from "../../services/historialService";

import {
  calcularResumenMaterialesM100,
} from "../../utils/m100Materials";
...
const calcular = (ancho, alto, hojas) => {
  if (hojas === 2) {
    return {
      ...
      marco: ancho - (3/16),
      latMarco: alto - (3/16),
      vidrioAncho: (ancho - (11 + 3/4)) / 2,
      vidrioAlto: alto - (9 + 3/16),
      vidrioMedio: null
    }
  } else if (hojas === 3) {
    return {
      ...
      marco: ancho - (3/16),
      latMarco: alto - (3/16),
      vidrioAncho: (ancho / 3) - (4 + 13/16),
      vidrioAlto: alto - (9 + 3/16),
      vidrioMedio: (ancho / 3) - (4 + 13/16)
    }
  } else {
    // 4 hojas
    return {
