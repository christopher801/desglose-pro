...
export const p92Calcular = (ancho, alto, hojas) => {
  const parts = []
  
  if (hojas === 2) {
    parts.push(
      { pieza: 'CAB-ALF', medida: (ancho / 2) - (9/16) },
      { pieza: 'JAMBAS', medida: alto - (2 + 7/16) },
      { pieza: 'CAB-RIEL', medida: ancho - (1 + 5/8) },
      { pieza: 'LATERAL', medida: alto - (1/8) },
      { pieza: 'VIDRIO_ANCHO', medida: (ancho / 2) - (3 + 13/16) },
      { pieza: 'VIDRIO_ALTO', medida: alto - (6 + 7/16) }
    )
  } else if (hojas === 3) {
    parts.push(
      { pieza: 'CAB-ALF', medida: (ancho / 3) + (3/8) },
      { pieza: 'JAMBAS', medida: alto - (2 + 7/16) },
      { pieza: 'CAB-RIEL', medida: ancho - (1 + 5/8) },
      { pieza: 'LATERAL', medida: alto - (1/8) },
      { pieza: 'VIDRIO_ANCHO', medida: (ancho / 3) - (2 + 14/16) },
      { pieza: 'VIDRIO_MEDIO', medida: (ancho / 3) - (3 + 3/8) },
      { pieza: 'VIDRIO_ALTO', medida: alto - (6 + 7/16) }
    )
  } else if (hojas === 4) {
    parts.push(
      ...
      { pieza: 'CAB-RIEL', medida: ancho - (1 + 5/8) },
      { pieza: 'LATERAL', medida: alto - (1/8) },
      { pieza: 'VIDRIO_ANCHO', medida: (ancho / 4) - (3 + 3/8) },
      { pieza: 'VIDRIO_ALTO', medida: alto - (6 + 7/16) }
    )
  }
...
export const p92FormatResult = (parts, hojas) => {
