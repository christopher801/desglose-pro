...
export const p65Calcular = (ancho, alto, hojas) => {
  const parts = []
  
  if (hojas === 2) {
    parts.push(
      { pieza: 'CAB-ALF', medida: (ancho / 2) - (11/16) },
      { pieza: 'JAMBAS', medida: alto - (2 + 1/8) },
      { pieza: 'CAB-RIEL', medida: ancho - (1 + 3/8) },
      { pieza: 'LATERAL', medida: alto - (1/8) },
      { pieza: 'VIDRIO_ANCHO', medida: (ancho / 2) - (3 + 3/16) },
      { pieza: 'VIDRIO_ALTO', medida: alto - (4 + 15/16) }
    )
  } else if (hojas === 3) {
    parts.push(
      { pieza: 'CAB-ALF', medida: (ancho / 3) + (1/8) },
      { pieza: 'JAMBAS', medida: alto - (2 + 1/8) },
      { pieza: 'CAB-RIEL', medida: ancho - (1 + 3/8) },
      { pieza: 'LATERAL', medida: alto - (1/8) },
      { pieza: 'VIDRIO_ANCHO', medida: (ancho / 3) - (2 + 6/16) },
      { pieza: 'VIDRIO_MEDIO', medida: (ancho / 3) - (2 + 11/16) },
      { pieza: 'VIDRIO_ALTO', medida: alto - (4 + 15/16) }
    )
  } else if (hojas === 4) {
    parts.push(
      ...
      { pieza: 'CAB-RIEL', medida: ancho - (1 + 3/8) },
      { pieza: 'LATERAL', medida: alto - (1/8) },
      { pieza: 'VIDRIO_ANCHO', medida: (ancho / 4) - (2 + 7/8) },
      { pieza: 'VIDRIO_ALTO', medida: alto - (4 + 15/16) }
    )
  }
...
export const p65FormatResult = (parts, hojas) => {
