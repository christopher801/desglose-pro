...
const P65 = () => {
  ...
  const handleAdd = () => {
    ...
    const newResult = {
      ...
      vidrioMedio: calculated.vidrioMedio ? FractionUtils.toSixteenths(calculated.vidrioMedio) : null
    }
          ...
          <div className="card-modern mb-4" style={{ padding: '1rem' }}>
            <div className="row g-3">
              ...
              <div className="col-md-3">
                ...
                <input type="text" name="ancho" value={formData.ancho} onChange={handleFormChange} placeholder="ej: 91 1/2" className="form-control" />
              </div>
              <div className="col-md-3">
                <label className="form-label small fw-bold">ALTO</label>
                <input type="text" name="alto" value={formData.alto} onChange={handleFormChange} placeholder="ej: 74 7/8" className="form-control" />
              </div>
              <div className="col-md-3">
                <label className="form-label small fw-bold">HOJAS</label>
          ...
          <div id="print-area">
            {results.length > 0 && (
              <div className="table-container">
                <div className="table-title">VENTANA P-65</div>
